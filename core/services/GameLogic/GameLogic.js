...
//  /*--------------------------------------------------------------------------*/
//  this.findArrowDirection = function (startLetter, startNumber, endLetter, endNumber) {
//
//    var direction = '';
//
...
//  };
  ...
  /*--------------------------------------------------------------------------*/
  this.createArrow = function (move, number) {

    var arrow = {x1: '', y1: '', x2: '', y2: '', style: ''};
    ...
    switch (number) {
      case '0':
        arrow.style = 'stroke:rgb(0,255,0);stroke-width:6;stroke-linecap:round';
        break;
      case '1':
        arrow.style = 'stroke:rgb(255,0,0);stroke-width:6;stroke-linecap:round';
        break;
      case '2':
        arrow.style = 'stroke:rgb(0,0,255);stroke-width:6;stroke-linecap:round';
        break;
      case '3':
        arrow.style = 'stroke:rgb(255,255,0);stroke-width:6;stroke-linecap:round';
        break;
      case '4':
        arrow.style = 'stroke:rgb(0,255,255);stroke-width:6;stroke-linecap:round';
        break;
    }
